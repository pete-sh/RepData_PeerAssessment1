---
PETER SUHNER: THIS IS PROBABLY MY CODE, but probably not - check!!!
====================================
...
I will use the mean for the 5-minute interval s as replacement for missing
values.
...
my_act$steps.y[is.na(my_act$steps.x)] <- as.integer(
        round(my_act$mean_steps[is.na(my_act$steps.x), ]))
