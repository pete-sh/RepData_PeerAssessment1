...
- Do these values differ from the estimates from the first part of the assignment? 
  - <i>I cannot see a major difference between the two patterns
  - However, the graph now shows <b>additional days</b> which were omitted in the original data
...
- What is the impact of imputing missing data on the estimates of the total daily number of steps?
  ...
  - With no dramatic change on neither the historgram nor the mean/median values of the such
